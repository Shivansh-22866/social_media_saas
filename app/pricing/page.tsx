...
const pricingPlans = [
    {
        name: "Basic",
        price: "19",
        priceId: "price_1QRE6wK68ZrnuvMgMCaed5fj",
        features: [
...

    {
        name: "Pro",
        price: "49",
        priceId: "price_1QREbGK68ZrnuvMgNYtX6PMv",
        features: [
...

    {
        name: "Enterprise",
        price: "59",
        priceId: "price_1QREcWK68ZrnuvMgtQGIM0x0",
        features: [
            "Unlimited AI-generated posts per month",
            "Twitter, Instagram and LinkedIn content",
            "Advanced analytics",
            "Priority support",
            "Custom branding"
